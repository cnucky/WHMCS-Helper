	...
	Chart.controllers.doughnut = Chart.controllers.pie = Chart.DatasetController.extend({
		...
		updateElement: function(arc, index, reset) {
			...
			var chart = me.chart,
				...
				circumference = reset && animationOpts.animateRotate ? 0 : arc.hidden ? 0 : me.calculateCircumference(index == 0 ? 0 : dataset.data[index]) * (opts.circumference / (2.0 * Math.PI)),
		...
		calculateTotal: function() {
			...
			helpers.each(meta.data, function(element, index) {
				value = index == 0 ? 0 : dataset.data[index];
			...
			if (opts.display) {
				...
				if (isHorizontal) {
					...
					cursor = {
						...
						y: me.top + (me.height/2) - (me.legendItems.length*((fontSize+10)/2)), //render label
						line: 0
					};
				}
