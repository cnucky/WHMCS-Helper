...
if (productType === "Web Hosting" || productType === "Business Hosting" || productType === "Reseller Hosting" || productType === "White Label Hosting" || productType === "Gold Hosting" || (productType === "Client Products" && (os === null || os === undefined) || productName === "YDG")) {
   ...
   //var setpass = "<iframe height=145px class=\"WEXTBTN\" style=\"left: 50%;width: 28.95%; margin-right:75%;overflow:hidden;border:none;\" src=\"http://dska.hostwinds.com/Windows/setpass.php?ip=" + IP + "\"></iframe>";
    var link = "<a class=\"WEXTBTN\" href='wext: psexec " + IP + " " + encodeURIComponent(username.val()) + " " + encodeURI(password.val()) + "'>Command Prompt</a>" + "<a href='wext: ping " + IP + "'  class=\"WEXTBTN\">Ping Server</a>" + "\n<a href='wext:  trace -w  " + IP + "'  class=\"WEXTBTN\">Traceroute</a>" + "<a href=\"https://vmaster.hostwindsdns.com:5656/admincp/manage.php?id=" + vserverid + "\" target=\"_blank\" class=\"WEXTBTN\">Solus</a>" + " <a href='wext: rdpaurl " + IP + ":" + port + " Administrator " + encodeURI(password.val()) + "'  class=\"WEXTBTN\">RDP Into Server</a>";
    content.html(contentHtml.replace('<div id="modcmdresult" style="display:none;"></div>', link).replace("<a href=\"SPAURL: " + encodeURIComponent(username.val()) + "@" + IPport + " -pw " + encodeURI(password.val()) + "\">SSH Into Server</a> - \n\t<a href=\"rdpaurl " + IPport + " Administrator " + encodeURI(password.val()) + "\" >RDP Into Server</a>", ""));
    //Linux VPSs
